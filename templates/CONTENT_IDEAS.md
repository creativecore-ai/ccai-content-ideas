...
> Linked to: BRAND_VOICE.md ([yes/no]) · HOOK_LIBRARY.md ([yes/no])
...
*(Filter your list to `status: idea` and pick from this batch's top picks.)*
...
- Audience pain that day: [what the user reported feeling/seeing]
- Format mix: [e.g. 5 reels, 3 LinkedIn, 2 email]
- Observations fed in: [list of fresh inputs the user mentioned]
...
**Top 3 picks at time of generation:** #X, #X, #X
